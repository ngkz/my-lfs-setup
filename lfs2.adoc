...
for applet in bootchartd halt poweroff reboot init mdev chpst setuidgid envuidgid envdir softlimit runsv runsvdir sv svc svok svlogd klogd logger logread syslogd; do
